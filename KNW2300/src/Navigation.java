...
import java.util.*; //unused import library

public class Navigation {
	private static final int RETURN_SUCCESS = 0;
	private static int RETURN_RANGE;
	private static int RETURN_SINGULAR;
	private static int RETURN_DIVERGENCE;
	...
	private int newton_raphson() {
		// TODO Auto-generated method stub
		return 0;
	}

	private void setAngles(double parseDouble, double parseDouble2) {
		// TODO Auto-generated method stub
